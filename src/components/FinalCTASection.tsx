    ...
    <section id="cta" className="py-20 md:py-28 bg-sand-dark/30">
      <div className="container-narrow text-center">
        <div className="space-y-8">
          ...
          <div className="pt-4">
            <a href="https://wa.me/message/SBUBJACPVCNGM1" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-foreground/60 hover:text-foreground transition-colors text-sm">
